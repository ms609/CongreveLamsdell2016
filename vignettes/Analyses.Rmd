...
*	Create a local directory (default: `C:/Research/iw`) with three subdirectories entitled `tntscript`, `S1-TNT`, and `Trees`.  `Trees` should contain the further subdirectories
`eq`, `k1`, `k2`, `k3`, `k5` and `kX`.
```{r eval=FALSE}
