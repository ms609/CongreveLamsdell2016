...
clCI <- vapply(clPhyDat, function (mat) phangorn::CI(clReferenceTree, mat), double(1))
...
clQuartets <- list(
  markov    = vapply(markov, Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  equal     = vapply(equal,  Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  implied1  = vapply(imp1,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  implied2  = vapply(imp2,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  implied3  = vapply(imp3,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  implied5  = vapply(imp5,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  implied10 = vapply(impX,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN),
  impliedC  = vapply(impC,   Quartet::MatchingQuartets, cf=referenceTree, BLANK_RETURN)
)

clPartitions <- list(
  markov    = vapply(markov, Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  equal     = vapply(equal , Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  implied1  = vapply(imp1,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  implied2  = vapply(imp2,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  implied3  = vapply(imp3,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  implied5  = vapply(imp5,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  implied10 = vapply(impX,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN),
  impliedC  = vapply(impC,   Quartet::MatchingSplits, cf=referenceTree, BLANK_RETURN)
)
```
